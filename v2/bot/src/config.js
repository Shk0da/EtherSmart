...
module.exports = {
  ...
  loanSizesUsdc:
    ...
    "5000,10000,25000",
  estimatedArbGas: parseInt(process.env.ESTIMATED_ARB_GAS || "900000", 10),
  ...
  artifactPath: path.join(
    ...
    "artifacts",
    "contracts",
    "HonestFlashArbV2.sol",
    "HonestFlashArbV2.json"
  ),
};
