...
module.exports = {
  version: "v4",
  scanStrategy: process.env.SCAN_STRATEGY || "trihop",
  ...
  loanSizesUsdc:
    ...
    "5000,10000,25000",
  estimatedArbGas: parseInt(process.env.ESTIMATED_ARB_GAS || "1100000", 10),
  ...
  healthPort: parseInt(process.env.HEALTH_PORT || "8789", 10),
  ...
  metricsDbPath:
    ...
    path.join(rootDir, "logs", "metrics-v4.db"),
  ...
  artifactPath: path.join(
    ...
    "artifacts",
    "contracts",
    "HonestFlashArbV4.sol",
    "HonestFlashArbV4.json"
  ),
};
