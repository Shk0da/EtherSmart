...
async function main() {
  ...
  const Arb = await ethers.getContractFactory("HonestFlashArbV3", deployer);
  ...
  console.log("\nHonestFlashArbV3 deployed at:", address);
  ...
  console.log(`  1. Set ARB_CONTRACT=${address} in v3/.env`);
  console.log(`  2. cd bot && npm install && npm start`);
}
